...
class TestBaseDeckGLViz(SupersetTestCase):
    ...
    def test_init_with_layer_filtering_applied(self):
        """Test BaseDeckGLViz.__init__ applies layer filtering when conditions are met."""
        datasource = self.get_datasource_mock()
        form_data = {
            "slice_id": 123,
            "adhoc_filters": [
    ...
    def test_init_without_layer_filtering(self):
        """Test BaseDeckGLViz.__init__ doesn't apply filtering when conditions aren't met."""
        datasource = self.get_datasource_mock()
        form_data = {
            "adhoc_filters": [
                {"clause": "WHERE", "subject": "col1", "operator": "==", "comparator": "value1"}
            ]
        }
    ...
    def test_should_apply_layer_filtering_true(self):
        """Test _should_apply_layer_filtering returns True when all conditions are met."""
        datasource = self.get_datasource_mock()
    ...
    def test_should_apply_layer_filtering_false_missing_adhoc_filters(self):
        """Test _should_apply_layer_filtering returns False when adhoc_filters is missing."""
        datasource = self.get_datasource_mock()
        test_viz = viz.BaseDeckGLViz(datasource, {})
    ...
    def test_should_apply_layer_filtering_false_no_layer_scoped_filters(self):
        """Test _should_apply_layer_filtering returns False when no layer scoped filters exist."""
        datasource = self.get_datasource_mock()
        test_viz = viz.BaseDeckGLViz(datasource, {})
    ...
    def test_has_layer_scoped_filters_true_with_dict(self):
        """Test _has_layer_scoped_filters returns True when filter dict has layerFilterScope."""
        datasource = self.get_datasource_mock()
        test_viz = viz.BaseDeckGLViz(datasource, {})
    ...
    def test_has_layer_scoped_filters_true_with_non_none_value(self):
        """Test _has_layer_scoped_filters returns True when layerFilterScope is not None."""
        datasource = self.get_datasource_mock()
        test_viz = viz.BaseDeckGLViz(datasource, {})
    ...
    def test_has_layer_scoped_filters_false_no_scoped_filters(self):
        """Test _has_layer_scoped_filters returns False when no filters have layerFilterScope."""
        datasource = self.get_datasource_mock()
        test_viz = viz.BaseDeckGLViz(datasource, {})
    ...
    def test_apply_multilayer_filtering_no_deck_slices(self):
        """Test _apply_multilayer_filtering returns original form_data when no deck_slices."""
        datasource = self.get_datasource_mock()
        test_viz = viz.BaseDeckGLViz(datasource, {})
    ...
    def test_apply_multilayer_filtering_slice_not_in_deck_slices(self):
        """Test _apply_multilayer_filtering returns original when slice_id not in deck_slices."""
        datasource = self.get_datasource_mock()
        test_viz = viz.BaseDeckGLViz(datasource, {})
    ...
    def test_get_deck_slices_from_filters_empty_filters(self):
        """Test _get_deck_slices_from_filters returns None when adhoc_filters is empty."""
        datasource = self.get_datasource_mock()
        test_viz = viz.BaseDeckGLViz(datasource, {})
    ...
    def test_get_filter_layer_scope_object_without_attribute(self):
        """Test _get_filter_layer_scope with object missing layerFilterScope attribute."""
        datasource = self.get_datasource_mock()
        test_viz = viz.BaseDeckGLViz(datasource, {})
